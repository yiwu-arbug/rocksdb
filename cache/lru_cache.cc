...
LRUCache::LRUCache(size_t capacity, int num_shard_bits,
                   ...
                   bool shard_cache_allocator,
                   std::unique_ptr<CacheAllocator> cache_allocator,
                   std::unique_ptr<CacheAllocator>* cache_allocator_shards)
    : ShardedCache(capacity, num_shard_bits, strict_capacity_limit,
                   std::move(allocator_factory), shard_cache_allocator,
                   std::move(cache_allocator), cache_allocator_shards) {
...
std::shared_ptr<Cache> NewLRUCache(const LRUCacheOptions& cache_opts) {
  return NewLRUCache(
      ...
      cache_opts.cache_allocator_factory, cache_opts.shard_cache_allocator);
}
...
std::shared_ptr<Cache> NewLRUCache(
  ...
  Status s = ShardedCache::InitCacheAllocator(
      cache_allocator_factory.get(), shard_cache_allocator,
      1 << num_shard_bits /*num_shards*/, &cache_allocator,
  ...
  return std::make_shared<LRUCache>(
      ...
      std::move(cache_allocator_factory), shard_cache_allocator,
      std::move(cache_allocator), cache_allocator_shards);
}
